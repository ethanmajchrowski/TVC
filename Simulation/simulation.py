...
class Rocket:
    def __init__(self, cfg: dict) -> None:
        ...
        # surface area of 3in cyl at 24in long: 18.9 sq. ft
        # weight of 8 sq. ft of fiberglass: 144g
    ...
    @property
    def TWR(self):
        return int(self.thrust_curve[self.thrust_index][1] / self.mass_kg * 9.81) # TWR = T / W = N / (kg * g)
